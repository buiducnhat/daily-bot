  ...
  return (
    <div>
      ...
      <Card>
        ...
        <CardContent>
          {activeGuild && (
            <div className="mb-4 w-fit rounded-lg border border-green-300 bg-green-100/80 p-2 dark:border-green-900 dark:bg-green-900/20">
          ...
          {!activeGuild && (
            <div>
              <p className="mb-4 text-muted-foreground text-sm">
                You need to connect a Discord server to use the bot. You must
